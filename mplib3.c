...
// struct que contem o buffer de msgs e o monitor
typedef struct channel_t {
        QueHead   *message_list;
        pthread_mutex_t mutex;

        //espera que o canal esteja disponivel para enviar msg
        pthread_cond_t wait_for_free_space;

        //espera qrue o canal esteja disponivel para receber msg
